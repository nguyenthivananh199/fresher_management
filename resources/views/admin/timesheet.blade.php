    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <table style="width:60%;text-align: left;margin-left: 15%;margin-right: 15%;">

                    <tr>
                   
                    <tr>
                    <td><div class="report_missing" style="width: 50px;height: 50px;text-align: center;padding-top:15px;">A/N</div></td>
                        <td> <p>Absence has no permission</p> </td>
                       

                    </tr>

                    <td><div class="report_out_time" style="width: 50px;height: 50px;text-align: center;padding-top:15px;">A/P</div></td>
                        <td> <p>Absence has permission</p> </td>
                       

                    </tr>
                    <td><div class="report_in_time" style="width: 50px;height: 50px;text-align: center;padding-top:15px;">Full</div></td>
                        <td> <p>Full day at work</p> </td>
                       

                    </tr>
                    <td><div style="width: 50px;height: 50px;background-color: white;text-align: center;padding-top:15px;">_</div></td>
                        <td> <p>Holiday</p> </td>
